...
set MAIN_JAR=dcm4che-tool-storescu-5.13.3.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-5.13.3.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-5.13.3.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-opencv-5.13.3.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-5.13.3.jar
